...
class GPUModelRunner(
    ...
    def __init__(
        ...
        # req_id -> RequestSparseClusterInfo
        self._sparse_cluster_info: dict[str, RequestSparseClusterInfo] = {}
    ...
    def _prepare_inputs(
        ...
        if self._has_sparse_attn and self._sparse_probe_info_enabled:
        ...
        if isinstance(attn_metadata, dict) and cluster_info is not None:
            ...
            for layer_name, layer_attn in attn_metadata.items():
                ...
                for ri in range(num_reqs):
                    ...
                    req_sparse_info = self._sparse_cluster_info.setdefault(rid, RequestSparseClusterInfo())
    ...
    def _ensure_sparse_cudagraph_cluster_info(
        ...
        steady_end_blocks = (
            spec.num_layer * spec.num_kv_heads * steady_end_blocks_per_head
        )
    ...
    def _pp_receive_prev_sampled_token_ids_to_input_batch(self) -> None:
        ...
        for i, req_id in enumerate(self.input_batch.req_ids):
            ...
            # appending a placeholder token id.
    ...
    def initialize_kv_cache(self, kv_cache_config: KVCacheConfig) -> None:
        ...
        # Register sparse attention metadata if any sparse groups exist.
    ...
    def _setup_sparse_attention(self) -> None:
        """Record sparse layer specs for metadata and debug helpers."""
        ...
        if self._sparse_probe_info_enabled:
            logger.info(
                ...
                "sparse_groups=%d sparse_layers=%d",

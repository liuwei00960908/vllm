...
class GPUModelRunner(
    ...
    def sample_tokens(
        ...
        if spec_config is not None:
            ...
            # The finally-block collection ran before the draft forward's
            # saves completed (defer path skips wait_for_save), so it may
            # miss windows. Merge the receipts drained here - after
            # wait_for_save - keeping the most advanced committed end per
            # request. Provenance: fork gpu_model_runner.py:4043-4059.
